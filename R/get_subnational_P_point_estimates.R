...
#' get_subnational_P_point_estimates(main_path = "results/, pkg_data, local=FALSE, mycountry=NULL)
#' Single-country example:
#' cleaned_subnatdata <- get_data(national=FALSE, local=TRUE, mycountry="Nepal", fp2030=TRUE)
#' pkg_data <- get_modelinputs(startyear=1990, endyear=2025.5, nsegments=12, raw_data = cleaned_subnatdata)
#' get_subnational_P_point_estimates(main_path = "results/, pkg_data, local=TRUE, mycountry="Nepal")
#' @export
